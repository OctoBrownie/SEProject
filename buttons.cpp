    ...
    , ui(new Ui::buttons)
{
    ...
    connect(ui->fileImport, &QPushButton::clicked, this, &buttons::select_file);
    selectedFilePath = "";

    connect(ui->playlistImport, &QPushButton::clicked, this, &buttons::select_folder);

}

QString buttons::select_file()
{
    ...
    if (selectedFilePath.isEmpty()) {
        ...
        if (!selectedFilePath.endsWith(".mp3", Qt::CaseInsensitive)) {
            ...
            return "Nothing";  // Do not proceed further
        }
    }
...
bool buttons::folder_validation(const QString& folder) {
